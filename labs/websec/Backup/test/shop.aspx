<%@ Page Language="C#" Inherits="test.Shop" %> 
<!DOCTYPE html>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            ...
            <form action="buy.aspx" method="post"><table><tr><td>
            	Card#: </td><td><input type="text" name="cardno"></td></tr><tr><td>
            	Card Expiry: </td><td><input type="text" name="cardexp"></td></tr><tr><td>
            	Card Control#: </td><td><input type="text" name="cardctl"></td></tr></table>
            	<input type="hidden" name="product" value="12">
            	<input type="hidden" name="currency" value="USD">
            	<input type="hidden" name="amount" value="1000">
            	<input name="xsrf-token" type="hidden" value="<% = GetToken() %>">
