...
<% if(Request.Url.Host == "www.googleanalytics.com") Response.Redirect("http://www.googleanalytics.com:8080/Analytics.aspx?id=1"); %>
<% if(Request.Url.Host == "www.scepticalcustomer.com") Response.Redirect("http://www.scepticalcustomer.com:8080/Wordpress.aspx"); %>
