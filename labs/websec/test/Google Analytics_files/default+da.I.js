(function() {
var _UDS_CONST_LOCALE = 'da';
var _UDS_CONST_SHORT_DATE_PATTERN = 'DMY';
var _UDS_MSG_SEARCHER_IMAGE = ('Billede');
var _UDS_MSG_SEARCHER_WEB = ('Internet');
var _UDS_MSG_SEARCHER_BLOG = ('Blog');
var _UDS_MSG_SEARCHER_VIDEO = ('Video');
var _UDS_MSG_SEARCHER_LOCAL = ('Lokalt');
var _UDS_MSG_SEARCHCONTROL_SAVE = ('gem');
var _UDS_MSG_SEARCHCONTROL_KEEP = ('Behold');
var _UDS_MSG_SEARCHCONTROL_INCLUDE = ('inkluder');
var _UDS_MSG_SEARCHCONTROL_COPY = ('kopier');
var _UDS_MSG_SEARCHCONTROL_CLOSE = ('luk');
var _UDS_MSG_SEARCHCONTROL_SPONSORED_LINKS = ('Sponsorerede links');
var _UDS_MSG_SEARCHCONTROL_SEE_MORE = ('se mere...');
var _UDS_MSG_SEARCHCONTROL_WATERMARK = ('klippet fra Google');
var _UDS_MSG_SEARCHER_CONFIG_SET_LOCATION = ('S\u00f8geomr\u00e5de:');
var _UDS_MSG_SEARCHER_CONFIG_DISABLE_ADDRESS_LOOKUP = ('Deaktiver adresseopslag');
var _UDS_MSG_SEARCHER_NEWS = ('Nyheder');
function _UDS_MSG_MINUTES_AGO(AGE_MINUTES_AGO) {return ('' + AGE_MINUTES_AGO + ' minutter siden');}
var _UDS_MSG_ONE_HOUR_AGO = ('1 time siden');
function _UDS_MSG_HOURS_AGO(AGE_HOURS_AGO) {return ('' + AGE_HOURS_AGO + ' timer siden');}
function _UDS_MSG_NEWS_ALL_N_RELATED(NUMBER) {return ('alle ' + NUMBER + ' relaterede');}
var _UDS_MSG_NEWS_RELATED = ('Relaterede artikler');
var _UDS_MSG_BRANDING_STRING = ('leveret af Google');
var _UDS_MSG_SORT_BY_DATE = ('Sorter efter dato');
...
var _UDS_MSG_MONTH_ABBR_MAY = ('maj');
...
var _UDS_MSG_DIRECTIONS = ('vejanvisninger');
var _UDS_MSG_CLEAR_RESULTS = ('ryd resultater');
var _UDS_MSG_SHOW_ONE_RESULT = ('vis \u00e9t resultat');
var _UDS_MSG_SHOW_MORE_RESULTS = ('vis flere resultater');
var _UDS_MSG_SHOW_ALL_RESULTS = ('vis alle resultater');
var _UDS_MSG_SETTINGS = ('indstillinger');
var _UDS_MSG_SEARCH = ('s\u00f8g');
var _UDS_MSG_SEARCH_UC = ('S\u00f8g');
var _UDS_MSG_POWERED_BY = ('leveret af');
function _UDS_MSG_LOCAL_ATTRIBUTION(LOCAL_RESULTS_PROVIDER) {return ('Liste over virksomheder leveret af ' + LOCAL_RESULTS_PROVIDER);}
var _UDS_MSG_SEARCHER_BOOK = ('Bog');
function _UDS_MSG_FOUND_ON_PAGE(FOUND_ON_PAGE) {return ('Side ' + FOUND_ON_PAGE);}
function _UDS_MSG_TOTAL_PAGE_COUNT(PAGE_COUNT) {return ('' + PAGE_COUNT + ' sider');}
var _UDS_MSG_SEARCHER_BY = ('efter');
var _UDS_MSG_SEARCHER_CODE = ('Kode');
var _UDS_MSG_UNKNOWN_LICENSE = ('Ukendt licens');
var _UDS_MSG_SEARCHER_GSA = ('Search Appliance');
var _UDS_MSG_SEARCHCONTROL_MORERESULTS = ('Flere resultater');
var _UDS_MSG_SEARCHCONTROL_PREVIOUS = ('Forrige');
var _UDS_MSG_SEARCHCONTROL_NEXT = ('N\u00e6ste');
var _UDS_MSG_GET_DIRECTIONS = ('Hent k\u00f8rselsvejledning');
var _UDS_MSG_GET_DIRECTIONS_TO_HERE = ('Hertil');
var _UDS_MSG_GET_DIRECTIONS_FROM_HERE = ('Herfra');
var _UDS_MSG_CLEAR_RESULTS_UC = ('Ryd resultater');
var _UDS_MSG_SEARCH_THE_MAP = ('s\u00f8g p\u00e5 kortet');
var _UDS_MSG_SCROLL_THROUGH_RESULTS = ('rul gennem resultater');
var _UDS_MSG_EDIT_TAGS = ('rediger tags');
var _UDS_MSG_TAG_THIS_SEARCH = ('forsyn denne s\u00f8gning med en etiket');
var _UDS_MSG_SEARCH_STRING = ('s\u00f8gestreng');
var _UDS_MSG_OPTIONAL_LABEL = ('valgfri etiket');
var _UDS_MSG_DELETE = ('slet');
var _UDS_MSG_DELETED = ('slettet');
var _UDS_MSG_CANCEL = ('annuller');
var _UDS_MSG_UPLOAD_YOUR_VIDEOS = ('overf\u00f8r din egen video');
var _UDS_MSG_IM_DONE_WATCHING = ('jeg er f\u00e6rdig med at se dennee');
var _UDS_MSG_CLOSE_VIDEO_PLAYER = ('luk videoafspiller');
var _UDS_MSG_NO_RESULTS = ('Ingen resultater');
var _UDS_MSG_LINKEDCSE_ERROR_RESULTS = ('Denne tilpassede s\u00f8gemaskine er ved at blive indl\u00e6st. Pr\u00f8v igen om lidt.');
var _UDS_MSG_COUPONS = ('Kuponer');
var _UDS_MSG_BACK = ('tilbage');
var _UDS_MSG_SUBSCRIBE = ('Abonner');
var _UDS_MSG_SEARCHER_PATENT = ('Patent');
var _UDS_MSG_USPAT = ('USA-patent');
var _UDS_MSG_USPAT_APP = ('USA-patentans\u00f8gning');
var _UDS_MSG_PATENT_FILED = ('Indgivet');
var _UDS_MSG_ADS_BY_GOOGLE = ('Annoncer fra Google');
var _UDS_MSG_SET_DEFAULT_LOCATION = ('Angiv fast stedsangivelse');
var _UDS_MSG_NEWSCAT_TOPSTORIES = ('Tophistorier');
var _UDS_MSG_NEWSCAT_WORLD = ('Verden');
var _UDS_MSG_NEWSCAT_NATION = ('Land');
var _UDS_MSG_NEWSCAT_BUSINESS = ('Erhverv');
var _UDS_MSG_NEWSCAT_SCITECH = ('Videnskab/tekn.');
var _UDS_MSG_NEWSCAT_ENTERTAINMENT = ('Underholdning');
var _UDS_MSG_NEWSCAT_HEALTH = ('Sundhed');
var _UDS_MSG_NEWSCAT_SPORTS = ('Sport');
var _UDS_MSG_NEWSCAT_POLITICS = ('Politik');
var _UDS_MSG_SEARCH_RESULTS = ('S\u00f8geresultater');
var _UDS_MSG_DID_YOU_MEAN = ('Mente du:');
var _UDS_MSG_CUSTOM_SEARCH = ('Tilpasset s\u00f8gning');
var _UDS_MSG_LABELED = ('M\u00e6rket');
var _UDS_MSG_LOADING = ('Indl\u00e6ser...');
var _UDS_MSG_ALL_RESULTS_SHORT = ('Alle');
var _UDS_MSG_ALL_RESULTS_LONG = ('Alle resultater');
var _UDS_MSG_REFINE_RESULTS = ('Pr\u00e6ciser resultaterne:');
function _UDS_MSG_REVIEWS(REVIEW_COUNT) {return ('' + REVIEW_COUNT + ' anmeldelser');}
function _UDS_MSG_CALORIES(CALORIES) {return ('' + CALORIES + ' cal');}
function _UDS_MSG_PRICE_RANGE(RANGE) {return ('Prisklasse: ' + RANGE + '.');}
function _UDS_MSG_PRICE(PRICE) {return ('Pris: ' + PRICE + '.');}
function _UDS_MSG_AVAILABILITY(AVAILABILITY) {return ('Tilg\u00e6ngelighed: ' + AVAILABILITY + '.');}
function _UDS_MSG_TELEPHONE(TELEPHONE) {return ('Tlf.: ' + TELEPHONE);}
function _UDS_MSG_RESULT_INFO(NUMBER_OF_RESULTS, SEARCH_TIME) {return ('Omkring ' + NUMBER_OF_RESULTS + ' resultater (' + SEARCH_TIME + ' sekunder)');}
var _UDS_MSG_FILE_FORMAT = ('Filformat:');
var _UDS_MSG_SHOWING_RESULTS_FOR = ('Viser resultater for');
var _UDS_MSG_SEARCH_INSTEAD_FOR = ('S\u00f8g i stedet efter');
function _UDS_MSG_FILTERED_RESULTS(NUM) {return ('For kun at vise dig de mest relevante resultater har vi fjernet nogle poster, som minder meget om de ' + NUM + ', der allerede vises. Hvis du vil, kan du ' + '<a>gentage s\u00f8gningen, hvor de udeladte resultater medtages' + '</a>.');}
var _UDS_MSG_ORDER_BY = ('Sort\u00e9r efter:');
var _UDS_MSG_ORDER_BY_RELEVANCE = ('Relevans');
var _UDS_MSG_ORDER_BY_DATE = ('Dato');
